     ...
     <div class="container-fluid">
         <div class="row">
             <div class="col-12">
                 <div class="card p-3">
                     <div class="card-text ">
                         <a class="text-primary text-uppercase" style="font-family: 'Bell MT';font-size: 16px"> <i class="fa fa-angle-double-right mr-2 text-danger"></i> Roles List </a>
                         <a href="{{route('roles.create')}}" class="float-right btn btn-outline-primary btn-sm"><i class="fas fa-plus-circle"></i> Create</a>
                     </div>
                     <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered"  id="file_export">
                                ...
                                @forelse($roles as $key=>$role)
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="4"><span class="badge badge-danger"> Sorry ! Data no Found ( : </span></td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
