                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-header bg-transparent border-bottom">
                            <i class="fa fa-plus-circle mr-2"></i> Create Role Form
                        </div>
                        <div class="card-body">
                            <form action="{{url('admin/roles')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="my-lg-4  mx-auto">
                                    <strong class="text-secondary font-18"><i class="fa fa-angle-double-right mr-2 text-danger"></i> Manage Permissions for Roles : </strong>
                                    @error('permissions')
                                    <p class="text-danger">
                                        <strong>{{$message}}</strong>
                                    </p>
                                    ...
                                    <div class="col">
                                        <div class="row">
                                            @forelse($resources as $resource)
                                                <div class="col-4">
                                                    <div class="mb-2"> Resource : <strong class="ml-2 text-info"> {{$resource->name}} </strong></div>
