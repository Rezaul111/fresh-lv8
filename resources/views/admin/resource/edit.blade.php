                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-header bg-transparent border-bottom">
                            <i class="fas fa-plus-circle mr-2"></i> Edit Resource Form
                        </div>
                        <div class="card-body">
                            <form action="{{url('admin/resources',$resource)}}" method="POST" enctype="multipart/form-data">
                              @csrf @method('PUT')
                               <div class="form-group">
                                   <label for="name"> Resource Name <span class="text-danger"> * </span>: </label>
                                   <input type="text" name="name" value="{{$resource->name??''}}"  class="form-control @error('name') is-invalid @enderror"  placeholder="Enter permission name . . ." />
                                   @error('name')
