                ...
                <div class="col-12 mt-4">
                    <div class="card">
                        <div class="card-header bg-transparent border-bottom">
                            <i class="fa fa-plus-circle mr-2"></i> Create Module Form
                        </div>
                        <div class="card-body">
                            <form action="{{url('admin/modules')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"  placeholder="Enter module name . . ." />
                                    @error('name')
                                ...
                                <div class="form-group mt-lg-5">
                                    ...
                                    <a href="{{route('modules.index')}}" class="btn btn-outline-danger btn-sm ml-2"><i class="fas fa-arrow-circle-left mr-1"></i>BACK</a>
                                </div>
                            </form>
                        </div>
                    </div>
