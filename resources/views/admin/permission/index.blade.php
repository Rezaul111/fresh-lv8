     ...
     <div class="container-fluid">
         <div class="row">
             <div class="col-12">
                 <div class="card p-3">
                     <div class="card-text ">
                         <a class="text-primary text-uppercase" style="font-family: 'Bell MT';font-size: 16px"> <i class="fa fa-angle-double-right mr-2 text-danger"></i> Permissions List </a>
                         <a href="{{route('permissions.create')}}" class="float-right btn btn-outline-primary btn-sm"><i class="fas fa-plus-circle"></i> Create</a>
                     </div>
                     <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered font-12" id="file_export">
                                ...
                                <tr>
                                    <th>#</th>
                                    <th title="module name">Resource</th>
                                    <th title="permission name">Permission</th>
                                    <th>Slug</th>
                                    <th>Updated_At</th>
                                    <th>Action</th>
                                </tr>
                                ...
                                @foreach($permissions as $key=>$permission)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('permissions.edit',$permission)}}" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></i></a>
